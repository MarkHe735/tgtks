...
import math
from knimeModule.knime20191126.IService.DService import DService
...
class DatetimeColsDeriv(DService):
    ...
    def DateDeriv(self,DateDf,idCol):
        ...
        ColsAll_filter = list(set(ColsAll)-set([idCol]))
        for col in ColsAll_filter:
            DateDf.loc[:, col + '_yearSeq'] = [x.year for x in DateDf.loc[:, col]]
